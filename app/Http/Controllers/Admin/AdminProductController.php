        ...
        try{
                ...
                $product = product::create($validatedData);
                 ...
                 foreach ($request->file('images') as $image) 
                 {
                    ...
                    $image1 = ImageManager::imagick()->read($image1);
