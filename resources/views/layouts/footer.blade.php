   ...
   <footer class="mt-100 overflow-hidden footer-style-2">
    ...
    function ctoggleVisibility(divId) 
    {
        if(visibleDivId === divId) 
        {
            visibleDivId = null;
    ...
    function subctoggleVisibility(divId) 
    {
        if(visibleDivId === divId) 
        {
            visibleDivId = null;
    ...
    function ptoggleVisibility(divId) 
    {
        if(visibleDivId === divId) 
        {
            visibleDivId = null;
