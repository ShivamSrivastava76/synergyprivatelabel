                                ...
                                <div class="filter-sorting me-4">
                                    <div class="collection-sorting position-relative d-none d-lg-block">
                                        <div class="sorting-header text_16 d-flex align-items-center justify-content-end">
                                            <span class="sorting-title ms-3">View:
                                                <sapn id="cdisplay"> List </sapn>
                                            </span>
                                        ...
                                        <ul class="sorting-lists1 list-unstyled m-0">
                                            <li><a href="#!" class="text_14 mx-3" onclick="ctoggleVisibility('cMenu1', 'cMenu11');" id="cMenu11"><img src="{{url('asset/img/icon/grid_view.png')}}" class="icon"> Grid view</a></li>
                                            <li><a href="#!" class="text_14 mx-3 d-none" onclick="ctoggleVisibility('cMenu2', 'cMenu21');"  id="cMenu21"><img src="{{url('asset/img/icon/list_view.png')}}" class="icon"> List View</a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-12">
                        <div class="collection-filter filter-drawer1">
                            ...
                            <div class="filter-widget d-lg-none">
                                ...
                                <div id="filter-mobile-sort" class="accordion-collapse ">
                                    <ul class="sorting-lists-mobile list-unstyled m-0">
                                       <li><a href="#!" class="text_14 mx-3" onclick="ctoggleVisibility('cMenu1');"><img src="{{url('asset/img/icon/grid_view.png')}}" class="icon"> Grid view</a></li>
                                        <li><a href="#!" class="text_14 mx-3" onclick="ctoggleVisibility('cMenu2');"><img src="{{url('asset/img/icon/list_view.png')}}" class="icon"> List View</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
